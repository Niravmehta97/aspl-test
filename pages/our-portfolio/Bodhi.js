    ...
    return (
        <>
            <Helmet>
                ...
                <link rel='canonical' href={`${baseUrl}/our-portfolio/Bodhi`}></link>
            </Helmet>
			<Navbar />
                ...
                <div className="container ">
                    <div className='portfolio-logo-wrapper text-center'>
                        <div className='portfolio-logo'>
                            <img className='sr-full-img' src="/images/portfolio-detail/Bodhi/logo.svg" alt="image" />  
                        </div>
                        <h1>Bodhi Web</h1>
                        <p>Bodhi is a modern Cycling Fashion Company. We focus on comfort, with a love for detail and elegance.</p>
            ...
            <div className='port-det-banner'>
                <div className='container'>
                    <img src="/images/portfolio-detail/Bodhi/111.png" alt="image" /> 
                </div>                
            </div>
                    ...
                    <div className="row">
                        <div className="col-lg-12 col-md-12">
                            <div className="port-det-text ">
                                <div className=''>
                                    <h3>We always send you a digital proof. A test print on fabric is of course also possible. Keep in mind that this will delay the production process, as the actual production will only start after a final confirmation.</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="website-data_box bodhi-web">
                                <img src="/images/portfolio-detail/Bodhi/00.png" alt="image" /> 
                            </div>                            
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="about-image-warp portdet-bodhi-bg"></div>
                        </div>
