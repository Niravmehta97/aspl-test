...
import { getsalesforcecloudData } from '../../../ComponentV1/ServiceBanner/Data/Salesforce_Cloud_Service_Data'
...
import { getSalesforceCloudServiceFAQDataV1 } from '../../../ComponentV1/FAQ/Data/SalesforceCloudServiceFAQV1_Data'


export default function SalesforceCloudServiceV1() {
  return (
    <>
    <Headerv1 />
    <ServiceBannerV1 data={getsalesforcecloudData()} />
    <TrustedByV1 />
    ...
    <WhyChooseUsV1 />
    <IndustryWeServeV1 />
    <FAQV1 data={getSalesforceCloudServiceFAQDataV1()} />
    <ContactV1 />
    <FooterV1 />
</>
  )
