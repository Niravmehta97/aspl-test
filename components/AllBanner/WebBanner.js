                            ...
                            <div className="row align-items-center">
                                <div className="col-lg-6">
                                    <div className="page-banner-content commonbanner-cont main-banner-content pr-15">
                                        ...
                                        <ul><li>
                                            ...
                                            </li><li className="active">Web Development</li></ul>
                                ...
                                <div className="col-lg-6">
                                    <div className="common-banner">
                                        {/* <img src="/images/all-banner/Services/WebDesign.png" alt="image" /> */}
                                        <picture>
                                            <source srcset="/images/all-banner/Services/WebDesign.webp" type="image/webp" />
                                            <img src="/images/all-banner/Services/WebDesign.png" alt="image" />
                                        </picture>
                                    </div>
                                </div>
