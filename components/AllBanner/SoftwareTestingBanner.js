                            ...
                            <div className="row align-items-center">
                                <div className="col-lg-6">
                                    <div className="page-banner-content commonbanner-cont main-banner-content pr-15">
                                        <h2>Software Testing And QA</h2>
                                        <ul><li>
                                                <Link href="/"><a>Home</a></Link>
                                            </li>
                                            <li>
                                                <Link href="/service"><a>Services</a></Link>
                                            </li><li className="active">Software Testing And QA</li></ul>
                                ...
                                <div className="col-lg-6">
                                    <div className="common-banner">
                                        {/* <img src="/images/all-banner/Services/softwaretesting.png" alt="image" /> */}
                                        <picture>
                                            <source srcset="/images/all-banner/Services/softwaretesting.webp" type="image/webp" />
                                            <img src="/images/all-banner/Services/softwaretesting.png" alt="image" />
                                        </picture>
                                    </div>
                                </div>
