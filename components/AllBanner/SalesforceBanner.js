                            ...
                            <div className="row align-items-center">
                                <div className="col-lg-6">
                                    <div className="page-banner-content commonbanner-cont main-banner-content pr-15">
                                        ...
                                        <ul><li>
                                            ...
                                            </li><li className="active">Salesforce Cloud Services</li></ul>
                                ...
                                <div className="col-lg-6">
                                    <div className="common-banner">
                                        <img src="/images/all-banner/Services/Salesforce-Cloud-Services.webp" alt="image" />
                                        {/* <picture>
                                            <source srcset="/images/all-banner/Services/MobileBanner.webp" type="image/webp" />
                                            <img src="/images/all-banner/Services/MobileBanner.png" alt="image" />
                                        </picture> */}
                                    </div>
                                </div>
                            </div>
